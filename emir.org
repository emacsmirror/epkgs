...
* Set ~emir-keep-packages~
#+NAME: set--emir-repo-sharing-packages
#+BEGIN_SRC emacs-lisp :var value=val--emir-repo-sharing-packages
  <<setup>>(emir--save-variable 'emir-repo-sharing-packages value)
#+END_SRC
#+NAME: val--emir-repo-sharing-packages
| Package            | Note                     |
|--------------------+--------------------------|
