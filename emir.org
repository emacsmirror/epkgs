...
| icicles              | heisenbug      |
| make-mode            | slow           |
| bibliothek           | unreachable    |
| dune                 | unreachable    |
| forecast             | unreachable    |
| org-variable-pitch   | unreachable    |
| paper-theme          | unreachable    |
| pylint               | unreachable    |
| shell-command+       | unreachable    |
| amread-mode          | stardiviner    |
| arduino-mode         | stardiviner    |
| company-nginx        | stardiviner    |
| edebug-inline-result | stardiviner    |
| eldoc-overlay        | stardiviner    |
| rainbow-fart         | stardiviner    |
| goldendict           | stardiviner    |
| inline-docs          | stardiviner    |
| kiwix                | stardiviner    |
| major-mode-icons     | stardiviner    |
| mu4e-marker-icons    | stardiviner    |
| ob-php               | stardiviner    |
| ob-redis             | stardiviner    |
| ob-sclang            | stardiviner    |
| ob-smiles            | stardiviner    |
| ob-spice             | stardiviner    |
| org-kindle           | stardiviner    |
| org-link-beautify    | stardiviner    |
| org-seek             | stardiviner    |
| org-tag-beautify     | stardiviner    |
| proxy-mode           | stardiviner    |
| sdcv                 | stardiviner    |
| smiles-mode          | stardiviner    |
| spice-mode           | stardiviner    |
...
* Set ~emir-keep-packages~
#+NAME: set--emir-kept-packages
#+BEGIN_SRC emacs-lisp :var value=val--emir-kept-packages
  <<setup>>(emir--save-variable 'emir-kept-packages value)
#+END_SRC
#+NAME: val--emir-kept-packages
| Package        | Reason         |
|----------------+----------------|
...
* Set ~emir--minority-reason~
#+NAME: set--emir--minority-reason
#+BEGIN_SRC emacs-lisp :var value=val--emir--minority-reason
  <<setup>>(emir--save-variable 'emir--minority-reason value)
#+END_SRC
#+NAME: val--emir--minority-reason
| Package             | Reason           |
|---------------------+------------------|
