...
#+BEGIN_SRC emacs-lisp
  <<setup>>(emir--save-variable 'emir-emacs-reference "emacs-28.1")
#+END_SRC
...
| Package    | Reason                         |
|------------+--------------------------------|
| connection | Don't add; part of dictionary  |
| dictionary | Don't add; part of Emacs 28.1  |
| dtache     | Don't add; renamed to detached |
| hierarchy  | Don't add; part of Emacs 28.1  |
| link       | Don't add; part of dictionary  |
